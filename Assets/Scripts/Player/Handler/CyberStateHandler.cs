...
namespace Player.Handler
{
    ...
    public class CyberStateHandler : MonoBehaviour, IPlayerStateHandler
    {
        ...
        public void SetStateAction(InGameEnums.PlayerStateType stateType, Action onEnter, Action onUpdate,
            Action onExit, Action onFixedUpdate)
        {
        ...
        public bool IsInvincible()
        {
            if (CurrentState.StateType == InGameEnums.PlayerStateType.Roll ||
                ...
                CurrentState.StateType == InGameEnums.PlayerStateType.Dead) return true;
            return false;
        }
        ...
        {
            return !(CurrentState.StateType is InGameEnums.PlayerStateType.Parry or InGameEnums.PlayerStateType.Guard
                or InGameEnums.PlayerStateType.AttackE or InGameEnums.PlayerStateType.Damage
                or InGameEnums.PlayerStateType.Dead);
        }

        public bool CanHandleGuardInput()
        {
            return !(CurrentState.StateType is InGameEnums.PlayerStateType.Roll or InGameEnums.PlayerStateType.Parry
                or InGameEnums.PlayerStateType.AttackE or InGameEnums.PlayerStateType.Damage
                or InGameEnums.PlayerStateType.Dead);
        }
        ...
        {
            return !(CurrentState.StateType is InGameEnums.PlayerStateType.Roll or InGameEnums.PlayerStateType.Guard
                or InGameEnums.PlayerStateType.AttackE or InGameEnums.PlayerStateType.Damage
                or InGameEnums.PlayerStateType.Dead);
        }
        ...
        {
            return (CurrentState.StateType is InGameEnums.PlayerStateType.Idle or InGameEnums.PlayerStateType.Move);
        }
